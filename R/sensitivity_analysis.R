...
#'
#' This is the primary function for GSA.
#' When regression formula and models (for egos and alters) are given,
#' and n_folds >= 2, the augmented estimators are used.
#' Otherwise, the non-augmented are used.
#'
